...
var Ajax = function () {	
    ...
    var runPageload = function () {
		...
		function pluginUnload() {
			...
			var pluginList = ['.datepicker', '.rangepicker', '.colorpicker', '.rgbapicker', '.timepicker', '#graph', '.single-daterange'];
		...
		var loadcontent = function() {		
		  $.ajax({
				...
				beforeSend: function() {
				  $('.content-w').addClass('animated animated-shortest fadeOut');
				...
				success: function(data) {
				   pluginUnload();
                   data = $(data).find('.content-w');
				   $('.content-w').html(data);
				},
				// On Complete reInit checkbox plugin and remove css animations
				complete: function() {
				   $('.content-w').removeClass('fadeOut').addClass('animated animated-shortest fadeInUp');	
				   $('#spinner').empty();
				...
				//   $('.content-w').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
				//	  $('.content-w').removeClass('animated animated-shortest fadeInUp fadeOut');
				 //  });
